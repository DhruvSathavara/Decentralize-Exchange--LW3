...
// Removes the 'removeLPTokensWei' amount of LP tokens from liquidity and 
// And also it calculate amount of 'ether' and 'CD' token that 'Exchange' contract will give back to user.

export const removeLiquidity = async (signer: any, removeLPTokensWei: BigNumber | number) => {
...
// Calculates the amount of `Eth` and `CD` tokens that would be returned back to user after he removes `removeLPTokenWei` amount of LP tokens from the contract

export const getTokensAfterRemove = async (provider: any, removeLPTokenWei: BigNumber, _ethBalance: BigNumber, cryptoDevTokenReserve: BigNumber) => {
    try {
