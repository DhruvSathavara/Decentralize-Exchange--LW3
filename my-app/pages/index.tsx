...
const Home: React.FC = () => {
  ...
  // Keeps track of the ether balance/ Reserve in the contract
  ...
  // getAmounts call various functions to retrive amounts for ethbalance, etc...
  ...
  const _swapTokens = async () => {
    try {
      ...
      // Check the user entered valid amount (not zero)
  ...
  // _getAmountOfTokensReceivedFromSwap:  Returns the number of Eth/Crypto Dev tokens that can be received when the user swaps `_swapAmountWEI` amount of Eth/Crypto Dev tokens.
...
console.log(_swapAmountWEI,'_swapAmountWEI');
...
console.log(reservedCD,'reservedCD');
  ...
  // _addLiquidity helps add liquidity to the exchange, If the user is adding initial liquidity, user decides the ether and CD tokens he wants to add to the exchange. 
  ...
  //_removeLiquidity: Removes the `removeLPTokensWei` amount of LP tokens from   liquidity and also the calculated amount of `ether` and `CD` tokens         
  ...
  //_getTokensAfterRemove: Calculates the amount of `Ether` and `CD` tokens that would be returned back to user after he removes `removeLPTokenWei` amount of LP tokens from the contract
  ...
  const renderButton = () => {
    // if wallet is not connected , return the button them to connect wallet
    if (!walletConnected) {
      return (
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                <input
                  ...
                  onChange={(e) => setAddEther(utils.parseEther(e.target.value.toString()))}
                />
                <input
                  type="number"
